...
def main():
	...
	while True:
    	...
    	#list of dictionaries with facial features
	    faces_landmarks_list = face_recognition.face_landmarks(frame)	
	    ...
	    for i in xrange(len(face_landmarks_list)):
	    	former_array = array
	    	array =[[]]
	    	for key in face_landmarks_list[i]:
	    		for key in face_landmarks_list[i]:
	    			for points in face_landmarks_list[i][key]:
